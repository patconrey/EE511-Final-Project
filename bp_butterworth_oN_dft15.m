function [f,H]=bp_butterworth_oN_dft15(fcenter,fcut,K,N,Norder)
% fcenter = center frequency
% fcut = cutoff frequency referenced to center frequency
...
% Example code:
% fo=30;fc=10;K=1;N=256;Norder=10;
